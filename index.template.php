...
<?php } ?>
	...
	<script src="//client.showdowndav.dynv6.net/config/config.js?"></script>
	<script src="//client.showdowndav.dynv6.net/js/battledata.js?"></script>
	<script src="//client.showdowndav.dynv6.net/data/search-index.js?"></script>
	<script src="//client.showdowndav.dynv6.net/data/pokedex.js?"></script>
	<script src="//client.showdowndav.dynv6.net/data/teambuilder-tables.js?"></script>
	<script src="//client.showdowndav.dynv6.net/data/learnsets.js?"></script>
	<script src="//client.showdowndav.dynv6.net/data/moves.js?"></script>
	<script src="//client.showdowndav.dynv6.net/data/abilities.js?"></script>
	<script src="//client.showdowndav.dynv6.net/data/items.js?"></script>
	<script src="//client.showdowndav.dynv6.net/data/formats-data.js?"></script>
	<script src="//client.showdowndav.dynv6.net/data/typechart.js?"></script>
	<script src="//client.showdowndav.dynv6.net/data/aliases.js?"></script>
	<script src="//client.showdowndav.dynv6.net/js/battle-dex-search.js?"></script>
	<script src="//client.showdowndav.dynv6.net/js/search.js?"></script>
